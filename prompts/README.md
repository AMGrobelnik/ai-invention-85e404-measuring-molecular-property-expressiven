...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 10 prompt(s)
  ...
  - round_2
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 16 prompt(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 4 prompt(s)
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `prompts/3_report_results/3_gen_full_paper.md` — 6 prompt(s)
